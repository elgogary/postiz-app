  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by Sanad Marketing Hub?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information Sanad Marketing Hub will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'Sanad Marketing Hub' : 'Gitroom'}?`
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        `${
          isGeneral ? 'Sanad Marketing Hub' : 'Gitroom'
